/*
Kernel OpenCL for SmartUpscaling_4xKNN1 - Ultra Performance
...
__kernel void upscale(__global uchar4 *src, __global uchar4 *dst, float src_width, float src_height, float dst_width, float dst_height, float aa_factor){
    ...
    */
    ...
    // Calculate the 4 zones 
    int top_left_begin[2] = {0, 0};
    int top_left_end[2] = {(int)(src_width / 2), (int)(src_height / 2)};

    int top_right_begin[2] = {(int)(src_width / 2), 0};
    int top_right_end[2] = {src_width, (int)(src_height / 2)};

    int bottom_left_begin[2] = {0, (int)(src_height / 2)};
    int bottom_left_end[2] = {(int)(src_width / 2), src_height};

    int bottom_right_begin[2] = {(int)(src_width / 2), (int)(src_height / 2)};
    int bottom_right_end[2] = {src_width, src_height};
    ...
    /* initial algorithm --> apply on each zone
